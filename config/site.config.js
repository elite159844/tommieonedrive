...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'devilblade196@gmail.com',
  ...
  footer: I made this file host using OneDrive CF Index/
